...
//结课
    ...
    @RequestMapping("/toSubmitHomework")
    public  String toSubmitHomework(HttpServletRequest request){
        //request.setAttribute("type",restService.getProfession());
        System.out.println("oooooooooooohsdjflsldsj");
        return "course/submitHomework";
    }

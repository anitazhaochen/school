...
<div class="x-body">
    ...
    <xblock>
        <button class="layui-btn" lay-submit="" lay-filter="openCourse"><i class="layui-icon"></i>统一开课</button>
        <span class="x-center" style="line-height:40px">请每日手动操作</span>
    </xblock>
    ...
    layui.use(['table','layer','laydate','form'],function () {
        ...
        t=table.render({
            ...
            cols:[[
                ...
                {field:'startdate',title:'开课日期',sort:true},
        ...
        form.on('submit(openCourse)',function () {
            $.ajax({
                url:'<%=basePath%>/course/openCourse.do',
                data:{},
                method:'post',
                success:function (res) {
                    res=JSON.parse(res);
                    var index=layer.alert('更新成功',{icon:6},function () {
                        t.reload();
                        layer.close(index);
                    });
                },
